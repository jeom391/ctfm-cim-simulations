...
> **구현 결과 (2026-09-20 갱신):** 이 지침대로 구현한 결과는
> [구현한 것](구현한것-2026-09-20.md), 남은 미구현과 사유는
> [구현 못한 것과 그 이유](구현못한이유-2026-09-20.md)에 있습니다. 두 PDF의 서술 중
> 엔진 crash 관련 두 항목은 직접 측정으로 반증됐으니 새 문서를 기준으로 삼으세요.
